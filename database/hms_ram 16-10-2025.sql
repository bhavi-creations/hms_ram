...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 16, 2025 at 07:36 AM
...
(9, 39, 43, '2025-10-07', '10:31:00', 'lungs problem', 'Pending', '2025-10-07 10:34:20', '2025-10-07 10:34:20', NULL),
(10, 40, 43, '2025-10-07', '10:56:00', 'yjyt', 'Pending', '2025-10-07 10:58:01', '2025-10-07 10:58:01', NULL),
(11, 41, 43, '2025-10-07', '11:17:00', '', 'Pending', '2025-10-07 11:18:28', '2025-10-07 11:18:28', NULL),
(12, 47, 43, '2025-10-09', '17:46:00', 'asthma', 'Confirmed', '2025-10-07 17:46:53', '2025-10-07 17:46:53', NULL),
(13, 47, 43, '2025-11-01', '16:42:00', 'sd', 'Confirmed', '2025-10-09 16:43:03', '2025-10-09 16:43:03', NULL);
...
--
-- Dumping data for table `assets_equipment`
--

INSERT INTO `assets_equipment` (`id`, `name`, `asset_tag`, `category`, `description`, `purchase_date`, `warranty_expiry_date`, `location`, `status`, `notes`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'x-ray machine', 'Eq-33nn', 'Medical Equipment', 'sfrtrt', '2025-10-14', '2025-11-08', 'kkd', 'Operational', 'fgnfg', '2025-10-15 15:28:47', '2025-10-15 15:28:47', NULL);
...
INSERT INTO `attendance` (`id`, `user_id`, `check_in_time`, `check_out_time`, `date`, `status`, `note`, `created_at`, `updated_at`) VALUES
(1, 5, '2025-09-29 08:30:00', NULL, '2025-09-29', 'Present', 'Shift started promptly.', '2025-09-29 16:26:00', '2025-09-29 16:26:00'),
(2, 6, '2025-09-29 09:00:00', '2025-09-29 17:00:00', '2025-09-29', 'Present', 'Full 8-hour shift completed.', '2025-09-29 16:26:00', '2025-09-29 16:26:00'),
(3, 7, '2025-09-29 10:15:00', NULL, '2025-09-29', 'Late', 'Late due to traffic.', '2025-09-29 16:26:00', '2025-09-29 16:26:00'),
(4, 1, '2011-11-29 00:00:00', '0000-00-00 00:00:00', '2025-09-29', 'Present', '', '2025-09-29 11:11:29', '2025-09-29 12:21:48'),
(5, 17, '2025-10-03 04:50:44', '2025-10-03 04:51:24', '2025-10-03', '', NULL, '2025-10-03 04:50:44', '2025-10-03 04:51:24'),
(6, 1, '2025-10-03 05:15:49', NULL, '2025-10-03', '', NULL, '2025-10-03 05:15:49', '2025-10-03 05:15:49'),
(7, 15, '2025-10-03 10:56:07', '2025-10-03 18:00:46', '2025-10-03', 'Present', NULL, '2025-10-03 10:56:07', '2025-10-03 18:00:46'),
(8, 17, '2025-10-04 10:31:40', NULL, '2025-10-04', '', NULL, '2025-10-04 10:31:40', '2025-10-04 10:31:40'),
(9, 15, '2025-10-04 10:33:39', NULL, '2025-10-04', '', NULL, '2025-10-04 10:33:39', '2025-10-04 10:33:39'),
(10, 13, '2025-10-09 17:01:32', NULL, '2025-10-09', '', NULL, '2025-10-09 17:01:32', '2025-10-09 17:01:32');
...
(9, 1, 'GEN-9', 'Available', NULL, '2025-07-26 05:38:05', '2025-10-09 16:52:57', '2025-07-26 05:53:00'),
(10, 1, 'GEN-10', 'Available', NULL, '2025-07-26 05:38:05', '2025-10-09 16:52:57', '2025-07-26 05:53:00'),
(11, 1, 'GEN-11', 'Available', NULL, '2025-07-26 05:51:53', '2025-10-09 16:52:57', '2025-07-26 05:53:00'),
(12, 1, 'GEN-12', 'Available', NULL, '2025-07-26 05:51:53', '2025-10-09 16:52:57', '2025-07-26 05:53:00'),
...
(33, 1, 'GEN-13', 'Available', NULL, '2025-10-09 16:52:57', '2025-10-09 16:52:57', NULL),
(34, 1, 'GEN-14', 'Available', NULL, '2025-10-09 16:52:57', '2025-10-09 16:52:57', NULL),
(35, 1, 'GEN-15', 'Available', NULL, '2025-10-09 16:52:57', '2025-10-09 16:52:57', NULL),
(36, 1, 'GEN-16', 'Available', NULL, '2025-10-09 16:52:57', '2025-10-09 16:52:57', NULL),
(37, 1, 'GEN-17', 'Available', NULL, '2025-10-09 16:52:57', '2025-10-09 16:52:57', NULL),
(38, 1, 'GEN-18', 'Available', NULL, '2025-10-09 16:52:57', '2025-10-09 16:52:57', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `diagnostics_orders`
--

CREATE TABLE `diagnostics_orders` (
  `id` int(11) NOT NULL,
  `patient_id` int(11) NOT NULL,
...
--
-- Dumping data for table `diagnostics_orders`
--

INSERT INTO `diagnostics_orders` (`id`, `patient_id`, `ordered_by`, `order_date`, `status`, `remarks`, `order_id_code`, `created_at`, `updated_at`) VALUES
(1, 38, 1, '2025-09-26 05:34:24', 'Completed', 'ggv', 'DIAG-20250926-0001', '2025-09-26 05:34:24', '2025-09-27 10:06:36'),
(2, 37, 1, '2025-09-26 06:05:33', 'Completed', 'dvsw', 'DIAG-20250926-0002', '2025-09-26 06:05:33', '2025-09-27 09:56:24'),
(5, 38, 1, '2025-09-26 06:23:37', 'In Progress', '', 'DIAG-20250926-0005', '2025-09-26 06:23:37', '2025-09-27 07:45:45'),
(6, 47, 1, '2025-10-09 17:08:21', 'Completed', 'ewcew', 'DIAG-20251009-0006', '2025-10-09 17:08:21', '2025-10-09 17:08:34');

-- --------------------------------------------------------

--
-- Table structure for table `diagnostics_order_files`
--

CREATE TABLE `diagnostics_order_files` (
  `id` int(11) NOT NULL,
  `diagnostics_order_item_id` int(11) NOT NULL,
...
--
-- Dumping data for table `diagnostics_order_files`
--

INSERT INTO `diagnostics_order_files` (`id`, `diagnostics_order_item_id`, `file_name`, `file_path`, `uploaded_by`, `created_at`, `updated_at`) VALUES
(5, 3, 'IMG_7816.JPG', '1758966984_8e646a49b20092f225d0.jpg', 0, '2025-09-27 09:56:24', '2025-09-27 09:56:24'),
(6, 10, 'IMG_7816 (1).JPG', '1758967546_88da3711f549309b7104.jpg', 0, '2025-09-27 10:05:46', '2025-09-27 10:05:46'),
(7, 10, 'Refund Request.pdf', '1758967546_c9bfdde33ad9fd96c266.pdf', 0, '2025-09-27 10:05:46', '2025-09-27 10:05:46'),
(8, 10, 'WhatsApp Image 2025-09-27 at 11.15.44 AM.jpeg', '1758967596_856dbca51b097abe1cde.jpeg', 0, '2025-09-27 10:06:36', '2025-09-27 10:06:36'),
(9, 12, 'Invoice_INV-202508230017 (1).pdf', '1760009914_2b60542c06f48d21b8c5.pdf', 0, '2025-10-09 17:08:34', '2025-10-09 17:08:34');

-- --------------------------------------------------------

--
-- Table structure for table `diagnostics_order_items`
--

CREATE TABLE `diagnostics_order_items` (
  `id` int(11) NOT NULL,
  `diagnostics_order_id` int(11) NOT NULL,
  `diagnostics_test_id` int(11) NOT NULL,
...
--
-- Dumping data for table `diagnostics_order_items`
--

INSERT INTO `diagnostics_order_items` (`id`, `diagnostics_order_id`, `diagnostics_test_id`, `result`, `status`, `created_at`, `updated_at`) VALUES
(3, 2, 5, 'bfe', 'In Progress', '2025-09-26 06:05:33', '2025-09-27 10:31:15'),
(8, 5, 6, NULL, 'Pending', '2025-09-26 06:23:37', '2025-09-26 06:23:37'),
(9, 5, 7, NULL, 'Pending', '2025-09-26 06:23:37', '2025-09-26 06:23:37'),
(10, 1, 1, 'we', 'Completed', '2025-09-26 10:43:15', '2025-09-27 10:06:36'),
(11, 1, 5, NULL, 'Completed', '2025-09-26 10:43:15', '2025-09-27 04:54:25'),
(12, 6, 1, 'vev', 'Completed', '2025-10-09 17:08:21', '2025-10-09 17:08:34');

-- --------------------------------------------------------

--
-- Table structure for table `diagnostics_tests`
--

CREATE TABLE `diagnostics_tests` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `diagnostics_tests`
--

INSERT INTO `diagnostics_tests` (`id`, `test_name`, `test_type`, `price`, `created_at`, `updated_at`) VALUES
(1, 'X-Ray Chest', 'Radiology', 1500.00, '2025-09-25 16:34:59', '2025-09-25 16:34:59'),
(2, 'Ultrasound Abdomen', 'Radiology', 2500.00, '2025-09-25 16:34:59', '2025-09-25 16:34:59'),
(3, 'CT Scan Head', 'Radiology', 8000.00, '2025-09-25 16:34:59', '2025-09-25 16:34:59'),
(4, 'MRI Brain', 'Radiology', 12000.00, '2025-09-25 16:34:59', '2025-09-25 16:34:59'),
(5, 'ECG', 'Cardiology', 500.00, '2025-09-25 16:34:59', '2025-09-25 16:34:59'),
(6, 'EEG', 'Neurology', 3000.00, '2025-09-25 16:34:59', '2025-09-25 16:34:59'),
(7, 'Endoscopy', 'Gastroenterology', 6500.00, '2025-09-25 16:34:59', '2025-09-25 16:34:59');
...
(15, 'DOC-250707-0001', 'raheem', 'raj', 'Male', '2025-07-01', '7897897897', 'doc@gmai.com', 'fsvfebsb', 'lingam', '7487477878', NULL, 'eye', 'mbbs', '2958453', '398593', 'ngerhe', 2, 'its a bio', 1, '2025-07-01', 'Full-time', 'temporary', 'senior eye specialist', 400.00, 15.00, 'SBI5572286', 'state bank of india', 'SBIN68', 'erxpp8768', '1755839005_a041515abcdb989e0ffb.jpg', NULL, '1760527963_2664dcab6f6426537f61.pdf', NULL, NULL, '[]', 1, 'Active', '2025-07-06 11:13:00', '2025-07-07 05:43:58', '2025-10-15 17:02:43'),
...
(43, 'DOC-250724-0029', 'ramesh', 'pilli', 'Male', '2008-01-24', '7897897895', 'rameshpilli@gmail.com', 'kkkd', 'ram', '6547896547', 13, 'lungs', 'mbbs', '295845324', '494989', 'council', 2, 'bio will', 3, '2025-07-16', 'Full-time', 'temporary', 'lungs spealis', 300.00, 2.00, '68768768768', 'SBI', 'SBIN68', 'erxpp8768', '1759988113_e555380a42e4a3b497f4.png', '1760009723_22313cf15d7efed1536e.png', '1760009756_661e18aecb11b6af2637.pdf', NULL, NULL, '[]', 1, 'Active', NULL, '2025-07-24 10:45:53', '2025-10-09 17:05:56'),
...
(9, 'sam ', 'fdbfd', '2025-10-09 10:05:41', '2025-10-09 10:15:52', '2025-10-09 10:15:52');
...
(5, 'LABRPOS-20251009-0005', 47, 1, '2025-10-09 17:07:33', 'Completed', 'vrwe', '2025-10-09 17:07:33', '2025-10-09 17:46:42');
...
(11, 14, 'stock_in_details_67 (1).pdf', '1760009882_148891642d387a0e3e25.pdf', '2025-10-09 17:08:02');
...
(14, 5, 2, 'pass', '2025-10-09 17:46:42', 'Completed', '2025-10-09 17:07:33', '2025-10-09 17:46:42');
...
(39, 'PAT-251007-00034', 'General', NULL, NULL, NULL, 'GEN-251007-00023', NULL, 'prakash', 'puli', '1999-12-14', 'Male', 'O+', 'single', 'student', 'kkd', '1234567890', 'prakesh@gmail.com', 'ram', '0123456789', 'non', 'no', 43, 3, 'no remarks', '[\"1759813460_8269_ChatGPT Image Sep 9_ 2025_ 09_58_17 AM.png\"]', 300.00, 0.00, 300.00, '2025-10-07 10:34:20', '2025-10-07 10:34:20'),
(40, 'PAT-251007-00035', 'Casualty', NULL, NULL, NULL, NULL, 'CUS-251007-00009', 'ravana', 'linga', '2000-02-12', 'Male', 'B+', 'single', 'student', 'rampa', '7894561230', 'ramaraoh@gmail.com', 'ram', '0123654789', 'no', 'no', 43, 2, 'mcf', '[\"1759814881_1473_ChatGPT Image Sep 9_ 2025_ 09_58_17 AM.png\"]', 300.00, 0.00, 300.00, '2025-10-07 10:58:01', '2025-10-07 10:58:01'),
(41, 'PAT-251007-00036', 'OPD', NULL, 'OPD-251007-00013', NULL, NULL, NULL, 'karanam', 'raj', '2017-01-06', 'Male', 'AB-', 'single', 'student', 'veaew', '0147852369', '', '', '', '', '', 43, 2, 'w', '[\"1759816108_1323_ChatGPT Image Sep 9_ 2025_ 09_58_17 AM.png\"]', 300.00, 0.00, 300.00, '2025-10-07 11:18:28', '2025-10-07 11:18:28'),
(42, 'PAT-251007-00037', 'General', NULL, NULL, NULL, 'GEN-251007-00024', NULL, 'Rama Rao', 'kankipati', '2025-10-01', 'Male', 'AB-', 'single', '', '', '3213213210', '', '', '', '', '', NULL, NULL, '', NULL, 0.00, 0.00, 0.00, '2025-10-07 11:37:26', '2025-10-07 11:37:26'),
(43, 'PAT-251007-00038', 'General', NULL, NULL, NULL, 'GEN-251007-00025', NULL, 'ranga', 'rao', '2025-10-11', 'Male', '', '', '', '', '0101010101', '', '', '', '', '', NULL, NULL, '', NULL, 0.00, 0.00, 0.00, '2025-10-07 11:52:05', '2025-10-07 11:52:05'),
(44, 'PAT-251007-00039', 'General', NULL, NULL, NULL, 'GEN-251007-00026', NULL, 'ramarao', 'ntr', '2025-10-01', 'Female', '', '', '', '', '7777788888', '', '', '', '', '', NULL, NULL, '', NULL, 0.00, 0.00, 0.00, '2025-10-07 12:32:22', '2025-10-07 12:32:22'),
(45, 'PAT-251007-00040', 'General', NULL, NULL, NULL, 'GEN-251007-00027', NULL, 'rathnam', 'raj', '1988-12-12', 'Other', '', '', '', '', '3232323232', '', '', '', '', '', NULL, NULL, '', NULL, 0.00, 0.00, 0.00, '2025-10-07 12:46:49', '2025-10-07 12:46:49'),
(46, 'PAT-251007-00041', 'OPD', NULL, 'OPD-251007-00014', NULL, NULL, NULL, 'tata', 'ratnna', '2025-09-28', 'Female', '', '', '', '', '1414141414', '', '', '', '', '', NULL, NULL, '', NULL, 0.00, 0.00, 0.00, '2025-10-07 12:49:37', '2025-10-07 12:49:37'),
(47, 'PAT-251007-00042', 'General', NULL, NULL, NULL, 'GEN-251007-00028', NULL, 'kumar', 'raj', '1999-11-11', 'Other', 'A+', 'single', 'student', 'rjy', '1231231231', 'kumarrak@gmai.com', 'ram', '456454564', 'fer', 'ervf', 43, 2, '', '[\"1759839413_6214_ChatGPT Image Sep 9_ 2025_ 09_58_17 AM.png\"]', 300.00, 0.00, 300.00, '2025-10-07 13:00:34', '2025-10-07 17:46:53');
...
(1, 'PAT', 42, '2025-10-07 13:00:34'),
(2, 'OPD', 14, '2025-10-07 12:49:37'),
(3, 'IPD', 51, '2025-08-22 12:16:09'),
(4, 'GEN', 28, '2025-10-07 13:00:34'),
(5, 'CUS', 9, '2025-10-07 10:58:01');
...
INSERT INTO `pharmacy_sales_persons` (`id`, `salesperson_id`, `first_name`, `last_name`, `phone`, `address`, `email`, `profile_picture`, `created_at`, `updated_at`, `status`) VALUES
(1, 'PHY-20250917-0001', 'Rama Rao', 'kankipatis', '9052555607', 'kakinada', 'ramarao@gmail.com', NULL, '2025-09-17 07:20:49', '2025-09-17 07:21:04', 1),
(3, 'PHY-20250917-0003', 'kanna', 'rao', '9876543210', 'gre', 'ramumarketing@gmail.com', NULL, '2025-09-17 07:26:25', '2025-09-17 07:33:12', 1),
(6, 'PHY-20250917-0004', 'nani', 'kankipati', '9876543210', 'sr', 'ramaraor@gmail.com', NULL, '2025-09-17 07:35:07', '2025-09-17 07:35:55', 1),
(7, 'PHY-20250918-0005', 'suresh', 'ganta', '7894561230', 'kkdrjy\r\n', 'sureshganta@gmail.com', NULL, '2025-09-18 06:09:54', '2025-09-18 12:31:40', 1),
(9, 'PHY-20250918-0006', 'range', 'rao', '1231231230', 'jjk', 'rangarao@gmail.com', NULL, '2025-09-18 12:06:29', '2025-09-18 12:09:46', 1),
(10, 'PHY-20250918-0007', 'ramu', 'lankey', '7894561237', 'ewwre', 'ramaraoew@gmail.com', NULL, '2025-09-18 12:26:45', '2025-09-18 12:26:45', 1),
(11, 'PHY-20250919-0008', 'Bhanu', 'prakesh', '1234567890', 'enee\r\n', 'bhanu@gmail.com', NULL, '2025-09-19 04:53:33', '2025-09-19 04:53:33', 1),
(24, 'PHY-20251011-0009', 'Rama Raover', 'kankipati', '9876543333', 'v', 'ramaravo@gmail.com', '1760163037_a4ee9fec241fbe0bdc9b.png', '2025-10-11 10:51:30', '2025-10-11 11:40:37', 1),
(25, 'PHY-20251011-0010', 'Rama Raover', 'kankipati', '7777888855', 'v', 'ramarawvo@gmail.com', '1760163099_ec6263e75c5bb17ffc14.png', '2025-10-11 10:51:40', '2025-10-11 11:41:39', 1);
...
(3, 'Self Referred', '8855220085', 'Self', '2025-06-25 16:04:43', '2025-10-09 09:41:11');
...
CREATE TABLE `roles` (
  ...
  `created_at` datetime DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `reports_to_role_id` int(11) DEFAULT NULL COMMENT 'The ID of the Department Head role this role reports to, if applicable.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `roles` (`id`, `name`, `management_level`, `description`, `created_at`, `updated_at`, `reports_to_role_id`) VALUES
(1, 'Admin', 'Executive Leader', 'System Administrator with full access.', '2025-06-25 13:05:41', '2025-10-03 10:57:07', NULL),
(2, 'Doctor', 'Team Member', 'Medical Doctor with patient management capabilities.', '2025-06-25 13:05:41', '2025-10-03 10:57:26', NULL),
(3, 'Receptionist', 'Senior Management', 'Front desk staff, manages appointments and basic patient info.', '2025-06-25 13:05:41', '2025-10-03 10:57:37', NULL),
(4, 'Pharmacist', 'Department Head', 'Manages pharmacy inventory and dispenses drugs.', '2025-06-25 13:05:41', '2025-10-03 10:57:42', NULL),
(5, 'Lab Technician', 'Department Head', 'Manages lab tests and enters results.', '2025-06-25 13:05:41', '2025-10-03 10:57:47', NULL),
(6, 'Nurse', 'Department Head', 'Provides patient care and manages medical records (basic).', '2025-06-25 13:05:41', '2025-10-03 10:57:52', NULL),
(7, 'Pharmacy Manager', 'Department Head', 'Manages pharmacy inventory, suppliers, staff, and approves returns.', '2025-07-29 15:54:23', '2025-10-04 11:37:42', NULL),
(8, 'Pharmacy Sales Person', 'Team Member', 'Handles medicine sales, billing, and basic patient interactions.', '2025-07-29 15:54:23', '2025-10-04 11:37:54', 7),
(9, 'Diagnostic Technician', 'Department Head', 'Manages the Diagnostics & Imaging and enters the results\r\n', '2025-09-27 11:32:11', '2025-10-03 10:58:21', NULL),
(10, 'Patient Portal', 'Team Member', 'This is patients login portal\r\n', '2025-10-07 09:36:33', '2025-10-07 09:36:45', 6);
...
INSERT INTO `specializations` (`id`, `name`, `description`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Cardiology', 'Treats disorders of the heart and blood vessels.', '2025-10-16 10:52:56', '2025-10-16 11:05:43', NULL),
(2, 'Pediatrics', 'Cares for the health and medical care of infants, children, and adolescents.', '2025-10-16 10:53:12', '2025-10-16 10:53:12', NULL),
(3, 'Dermatology', 'Deals with the skin, nails, hair and its diseases.', '2025-10-16 10:53:24', '2025-10-16 10:53:24', NULL),
(4, 'Orthopedics', 'Focuses on injuries and diseases of the musculoskeletal system.', '2025-10-16 10:53:40', '2025-10-16 10:53:40', NULL),
(5, 'Neurology', 'Deals with disorders of the nervous system.', '2025-10-16 10:53:53', '2025-10-16 10:53:53', NULL),
(6, 'Oncology', 'Diagnosis and treatment of cancer.', '2025-10-16 10:54:04', '2025-10-16 10:54:04', NULL),
(7, 'Gastroenterology', 'Focuses on the digestive system and its disorders.', '2025-10-16 10:54:15', '2025-10-16 10:54:15', NULL),
(8, 'Endocrinology', 'Treats disorders of the endocrine system, such as diabetes and thyroid disease.', '2025-10-16 10:54:27', '2025-10-16 10:54:27', NULL),
(9, 'Ophthalmology', 'Focuses on eye and vision care.', '2025-10-16 10:54:39', '2025-10-16 10:54:39', NULL),
(10, 'General Surgery', 'Performs surgical procedures for various conditions across the body.', '2025-10-16 10:54:55', '2025-10-16 10:54:55', NULL),
(11, 'sampe', 'dbftrstewcwecw', '2025-10-16 10:55:05', '2025-10-16 10:59:31', '2025-10-16 10:59:31'),
(12, 'dvsre', 'revwced', '2025-10-16 10:58:58', '2025-10-16 10:59:26', '2025-10-16 10:59:26');
...
INSERT INTO `users` (`id`, `role_id`, `manager_id`, `first_name`, `last_name`, `username`, `email`, `password`, `phone_number`, `address`, `status`, `last_login`, `created_at`, `updated_at`) VALUES
(1, 1, NULL, 'System', 'Admin', 'admin', 'admin@example.com', '$2y$10$Sh/3KsbkbQ12FXx.ZBngVOi1ZOTuKa4swBJBgjtIhvZ7HhXQ.Dh3W', '9876543210', '123 Admin Street, City', 'active', '2025-10-16 09:13:50', '2025-06-25 13:05:57', '2025-10-16 09:13:50'),
(2, 2, NULL, 'Jane', 'Smith', 'drsmith', 'jane.smith@hms.com', '$2y$10$f1/gyLrKkbOx7vySl.bDV.JyiyyHRGrgfQ9zw0yP7s9OOt0KrKVha', '9988776655', '456 Medical Avenue, City', 'active', '2025-06-25 10:43:02', '2025-06-25 16:10:32', '2025-07-02 10:07:34'),
(3, 2, NULL, 'ramapappa', 'rao', 'doctor', 'vgv@gmail.com', '$2y$10$Xdxj1UOk1PmJc9FCOFHA3uY37u2DtyTh31iBvbPuhUFx7XdjeV1.a', '7897897897', 'fgb', 'active', NULL, '2025-07-07 11:19:37', '2025-07-07 11:19:37'),
(4, 2, NULL, 'mani', 'man', 'mani', 'bhavicreations@gmail.com', '$2y$10$TfEyAe07XY3Eaj0rcVIeB.hi6evsQ3kKidZnUBwJw1KuVqWmFOlgK', '', '', 'active', '2025-07-08 04:59:54', '2025-07-07 12:05:19', '2025-07-08 04:59:54'),
(5, 2, NULL, 'mani', 'man', 'maniraj', 'bhavicreations@gmail.com', '$2y$10$rwP8b1ymOL5B10deOvjyFe5eiq5jhWcHEcJLHBEXsyj8bHmXs42MW', '', '', 'active', NULL, '2025-07-07 12:09:03', '2025-07-07 12:09:03'),
(6, 2, NULL, 'divya', 'rani', 'mani', 'bhavicreations@gmail.com', '$2y$10$vK/lrcY2P1gNSrzMSu8O/eJuY6XlH5J.z5fcGZE71uITtd9SpWKQC', '', '', 'active', NULL, '2025-07-07 12:23:24', '2025-07-07 12:23:24'),
(7, 2, NULL, 'mango', 'seed', 'mango', 'bhavicreations@gmail.com', '$2y$10$ve/LjK8bNLLPsgiuXc9/peOipoFswf6r47nX2ZGdUvg2Pz8eyMrJC', '7897897897', 'sb g', 'active', NULL, '2025-07-07 12:25:54', '2025-07-07 12:25:54'),
(8, 2, NULL, 'papaya', 'papaya', 'papaya', 'bhavicreations@gmail.com', '$2y$10$LVF..XS3HN3gHUo.oiSNPedoeQNlVIU7opG.A/dzc/zlkU4FlPh/K', '', '', 'active', NULL, '2025-07-08 07:58:28', '2025-07-08 07:58:28'),
(9, 2, NULL, 'watermelon', 'fruit', 'watermelon', 'bhavicreations@gmail.com', '$2y$10$v505zIh/uAK2RXbfTvbrT.w0I.imDV9q89ayeiRIZWZPqbSppXU7.', '', '', 'active', NULL, '2025-07-08 08:00:45', '2025-07-08 08:00:45'),
(10, 2, NULL, 'bheam', 'bheam', 'bheam', 'abhi@gmail.com', '$2y$10$kjsLBUKrFUysEAG6igivd.yGE6W8S0.pNpzhH8/nN9IgjA1sa6TEm', '', '', 'active', NULL, '2025-07-08 08:03:56', '2025-07-08 08:03:56'),
(11, 2, NULL, 'sharak', 'sharak', 'sharak', 'bhavicreations3022@gmail.come', '$2y$10$W6chLlM85QpZIu6ERUwfGear8ptlGYWrCgoD.DDbg1BR80BiU.kIq', '', '', 'active', '2025-07-08 11:49:57', '2025-07-08 09:18:21', '2025-07-08 11:49:57'),
(12, 2, NULL, 'ramun', 'creations', 'ramun', 'bhavicreations@gmail.com', '$2y$10$o5.M0hPP2XITfdiH06/bIOxKmsf4FaOLbsb63S10DonI61tHyPdHK', '', '', 'active', '2025-07-08 11:49:14', '2025-07-08 09:21:53', '2025-07-08 11:49:14'),
(13, 2, NULL, 'ramesh', 'pilli', 'ramesh', 'rameshpilli@gmail.com', '$2y$10$h4NrHZLzeQxYCPgnoMSjwucG3/ypEkzDD9DCGpCjyuDRM8sYAltkG', '7897897895', 'kkkd', 'active', '2025-10-14 17:56:07', '2025-07-24 10:45:53', '2025-10-14 17:56:07'),
(14, 2, NULL, 'Harsh vardhan', 'Basara', 'harsha', 'abhvasi@gmail.com', '$2y$10$CDdwoNTxRR38zKognEZOteNUFqoGfhYSnji8jXj0YY8xIvF5deMki', '7531598254', '', 'active', NULL, '2025-07-25 05:13:34', '2025-07-25 05:13:34'),
(15, 7, NULL, 'Pharmacy', 'manager', 'pharmacymanager', 'pharmacymanager@gmail.com', '$2y$10$k5D2EBzmfLmXf27c8k/bxetJHqKRXIro0XhyG9NYc.k6Vw33cQlri', '1234567890', '123 Manager St, City', 'active', '2025-10-10 17:03:02', '2025-09-17 17:38:30', '2025-10-10 17:03:02'),
(16, 8, NULL, 'sales', 'person', 'salesperson', 'salesperson@gmail.com', '$2y$10$oQylRKBYrYu5ih55WP4P..gx.A3Y.i8q3oNTh9BdWsSv6hHDNqTuq', NULL, NULL, 'active', '2025-10-10 17:36:30', '2025-09-18 10:46:01', '2025-10-10 17:36:30'),
(17, 8, NULL, 'suresh', 'ganta', 'PHY-20250918-0005', 'sureshganta@gmail.com', '$2y$10$E/WgGAz2iGoB.P.Cd0fKg.gPJytyDiGuJTpQxDgZV1zOZwmLicKzm', '7894561230', 'kkdrjysfb\r\n', 'active', '2025-10-04 10:31:30', '2025-09-18 06:09:54', '2025-10-04 10:31:30'),
(18, 8, NULL, 'suresh', 'raja', 'PHY-20250918-0006', 'sureshgantaw@gmail.com', '$2y$10$zqELzrAPJSmR9VG4HvFKoe8.ucd.ODus4mLrbCqjqnc3GgtWqC75G', '7894561230', NULL, 'active', '2025-09-19 12:28:45', '2025-09-18 06:11:08', '2025-09-19 12:28:45'),
(19, 8, NULL, 'range', 'rao', 'PHY-20250918-0006', 'rangarao@gmail.com', '$2y$10$2eSsEcN97Tpepv7BGIR1be2yV.qyAybHzIB9OY1weZRJpMPZFg8.q', '0000000000', 'rjy', 'active', NULL, '2025-09-18 12:06:29', '2025-09-23 06:52:10'),
(20, 8, NULL, 'ramu', 'lankey', 'PHY-20250918-0007', 'ramaraoew@gmail.com', '$2y$10$QalH7X.IXGET5XpR4vIVz.eW./ilCsiu5ohBItrVAMokpRuyqhjri', '7894561237', NULL, 'active', '2025-09-19 04:13:26', '2025-09-18 12:26:45', '2025-09-19 04:13:26'),
(21, 8, NULL, 'Bhanu', 'prakesh', 'PHY-20250919-0008', 'bhanu@gmail.com', '$2y$10$grTUWBU20qOMhcuDBdjbNO6hIq7J9Nl9xL282WJKPMUCMn2W31C9K', '1234567890', NULL, 'active', NULL, '2025-09-19 04:53:33', '2025-09-19 04:53:33'),
(22, 5, NULL, 'Lisa', 'Lab', 'labtech', 'lisa.lab@hms.com', '$2y$10$80aZeDgy21oD6brVfwZEtuCu2szo5ZPfwXXvDPQ1zHt/X88/CxOfG', '9000000005', 'Main Lab', 'active', '2025-09-27 12:02:32', '2025-09-27 17:29:22', '2025-09-27 12:02:32'),
(23, 9, NULL, 'Daniel', 'Diag', 'diagtech', 'daniel.diag@hms.com', '$2y$10$fYyRpzb2S.DHNY6j3iDEEu7aIWuB7/I3vF2pi6nnzmBTlKD9G86dS', '9000000009', 'Imaging Suite 3', 'active', '2025-09-27 12:02:59', '2025-09-27 17:29:22', '2025-09-27 12:02:59'),
(24, 7, NULL, 'Pharmacy', 'manager', 'pharmacymanager', 'pharmacymanager@gmail.com', '$2y$10$k5D2EBzmfLmXf27c8k/bxetJHqKRXIro0XhyG9NYc.k6Vw33cQlri', '1234567890', '123 Manager St, City', 'active', '2025-10-04 10:33:04', '2025-09-17 17:38:30', '2025-10-04 10:33:04'),
(25, 10, NULL, 'prakash', 'puli', 'PAT-251007-00034', 'prakesh@gmail.com', '$2y$10$aZhb6UzNr6BMFKAwkiYZh.you67Tyaec4uV9chgyheZ/BQh9MdcCy', '1234567890', NULL, 'active', '2025-10-07 10:55:23', '2025-10-07 10:34:20', '2025-10-07 10:55:23'),
(26, 10, NULL, 'ravana', 'linga', 'PAT-251007-00035', 'ramaraoh@gmail.com', '$2y$10$e8mNL.H2WKiIE4Su3gZ00uhG1maCczg4ZDT/Es.Z4tOf1jrofska2', '7894561230', NULL, 'active', '2025-10-07 11:02:05', '2025-10-07 10:58:01', '2025-10-07 11:02:05'),
(27, 10, NULL, 'ranga', 'rao', 'PAT-251007-00038', 'ramaraoer@gmail.com', '$2y$10$Z/qwECutQfBdedDy3EpJYupWJheP0Zx3V3vcJmQZCQEo0MnIo1McS', '0101010101', '', 'active', '2025-10-07 12:19:05', '2025-10-07 11:52:05', '2025-10-09 16:34:18'),
(28, 10, NULL, 'ramarao', 'ntr', 'PAT-251007-00039', 'vkconstruntfe43ioens@gmail.com', '$2y$10$nODfBzoKuWhukX3gm8Ahuu1el0tcwPpYmdRPn2fHxK6obod6/Ryti', '7777788888', '', 'active', NULL, '2025-10-07 12:32:22', '2025-10-09 16:35:05'),
(29, 10, NULL, 'rathnam', 'raj', 'PAT-251007-00040', '', '$2y$10$NNk96OqCft3A6RGuEwmNkuEQcTzuGINdGKcEfI4FpoJjbmMgOvRPe', '3232323232', NULL, 'active', NULL, '2025-10-07 12:46:50', '2025-10-07 12:46:50'),
(30, 10, NULL, 'tatae', 'ratnna', 'PAT-251007-00041', 'vkconstruntiasarons111@gmail.com', '$2y$10$5IKz.cFQTQjEcjJVCLMBmuos3edLriqyLSSOiY5s8GeRRJSzIh1Nm', '1414144444', '', 'active', '2025-10-08 13:31:16', '2025-10-07 12:49:37', '2025-10-09 16:40:45'),
(31, 10, NULL, 'kumar', 'raj', 'PAT-251007-00042', '', '$2y$10$zlh0RPhvjav7ygbgAEfjveKSQh/qV1Py/qY6C9M2iRcYTwXr4JnJK', '1231231231', NULL, 'active', '2025-10-10 17:20:36', '2025-10-07 13:00:34', '2025-10-10 17:20:36'),
(34, 3, NULL, 'Rama Rao', 'kankipati', 'ramarao', 'vkconstruntioens@gmail.com', '$2y$10$WGff8JQDHXHLpg2LheKFHuZENaB9YmBC7Eg3XK3w9FMuJdYnHVnc.', '3333333321', '', 'active', NULL, '2025-10-09 14:53:58', '2025-10-09 14:53:58'),
(35, 3, NULL, 'mani malladi ', 'man', 'manimalladi', 'mani43a@gmail.com', '$2y$10$pQbsOU5tgXdhJzBr6yobeu.rlRkR7ordqd3QK3jBXy/OniVQexrYa', '7444444444', 'fd', 'active', NULL, '2025-10-09 14:54:43', '2025-10-09 16:41:57'),
(36, 8, NULL, 'Rama Rao', 'wefwe', 'PHY-20251011-0001', 'abahi@gmail.com', '$2y$10$lRdeB99me/GujLROYQ2TduvJlogtXuC2vn.fsILmqzVg3/WZ.alzu', '9876543216', NULL, 'active', NULL, '2025-10-11 10:45:06', '2025-10-11 10:45:06'),
(37, 8, NULL, 'Rama Raover', 'kankipati', 'PHY-20251011-0009', 'ramaravo@gmail.com', '$2y$10$U8c2hdfR6p6oGwSy1g8.cuj1XNshUXGaQaHjLPflM/Dlb66AV4Ine', '9876543222', NULL, 'active', NULL, '2025-10-11 10:51:30', '2025-10-11 10:51:30'),
(38, 8, NULL, 'Rama Raover', 'kankipati', 'PHY-20251011-0010', 'ramarawvo@gmail.com', '$2y$10$FBia8txEnDV1S6KuhqGt..S7gMGu3UxhsUVPmpsj7.I1kH5LH5mnO', '9876543222', NULL, 'active', NULL, '2025-10-11 10:51:40', '2025-10-11 10:51:40');
...
(1, 'General Ward', 'rver', 18, 'Active', '2025-07-26 05:38:05', '2025-10-09 16:52:57', NULL, 'GEN'),
...
--
-- Indexes for table `diagnostics_orders`
--
ALTER TABLE `diagnostics_orders`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `order_id_code` (`order_id_code`),
  ADD KEY `patient_id` (`patient_id`),
  ADD KEY `ordered_by` (`ordered_by`);

--
-- Indexes for table `diagnostics_order_files`
--
ALTER TABLE `diagnostics_order_files`
  ADD PRIMARY KEY (`id`),
  ADD KEY `diagnostics_order_item_id` (`diagnostics_order_item_id`);

--
-- Indexes for table `diagnostics_order_items`
--
ALTER TABLE `diagnostics_order_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `diagnostics_order_id` (`diagnostics_order_id`),
  ADD KEY `diagnostics_test_id` (`diagnostics_test_id`);

--
-- Indexes for table `diagnostics_tests`
--
ALTER TABLE `diagnostics_tests`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `diagnostics_orders`
--
ALTER TABLE `diagnostics_orders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `diagnostics_order_files`
--
ALTER TABLE `diagnostics_order_files`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `diagnostics_order_items`
--
ALTER TABLE `diagnostics_order_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `diagnostics_tests`
--
ALTER TABLE `diagnostics_tests`
...
--
-- Constraints for table `diagnostics_orders`
--
ALTER TABLE `diagnostics_orders`
  ADD CONSTRAINT `diagnostics_orders_ordered_by_foreign` FOREIGN KEY (`ordered_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `diagnostics_orders_patient_id_foreign` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `diagnostics_order_files`
--
ALTER TABLE `diagnostics_order_files`
  ADD CONSTRAINT `diagnostics_order_files_item_id_foreign` FOREIGN KEY (`diagnostics_order_item_id`) REFERENCES `diagnostics_order_items` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `diagnostics_order_items`
--
ALTER TABLE `diagnostics_order_items`
  ADD CONSTRAINT `diagnostics_order_items_order_id_foreign` FOREIGN KEY (`diagnostics_order_id`) REFERENCES `diagnostics_orders` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `diagnostics_order_items_test_id_foreign` FOREIGN KEY (`diagnostics_test_id`) REFERENCES `diagnostics_tests` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `fk_manager_user` FOREIGN KEY (`manager_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,

...
class Laboratory extends BaseController
{
    ...
    // Add this method to display the form to enter results and upload files
    public function enterResult($orderId)
    {
        ...
        // Fetch related files for each order item
    ...
    // Add this method to handle the form submission for files and data
    ...
    // Add this method to handle file deletion
    ...
    {
        // Fetch all lab orders with patient and user details using LEFT JOINs
        $builder = $this->labOrderModel->builder();
        $builder->select('lab_orders.*, lab_orders.id AS order_id, 
                           IFNULL(patients.patient_id_code, "N/A") AS patient_id,
                           IFNULL(CONCAT_WS(" ", patients.first_name, patients.last_name), "N/A") AS patient_name, 
    ...
    {
        // Get main order and patient details
        $order = $this->labOrderModel->builder()
    ...
    /**
     * Delete a lab report and its associated files.
     * @param int $orderId The ID of the lab order.
     * @return \CodeIgniter\HTTP\RedirectResponse
     */
    public function delete_report($orderId)
    {
        ...
        // Delete the main lab order entry

    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <form action="<?= site_url('pharmacy/suppliers/store') ?>" method="post">
                    <?= csrf_field() ?>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="<?= set_value('name') ?>" placeholder="Enter supplier name" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="address" name="address" rows="3" placeholder="Enter supplier address"><?= set_value('address') ?></textarea>
                        </div>
                    </div>

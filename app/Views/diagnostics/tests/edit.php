        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">
                    <i class="fas fa-edit mr-2 text-info"></i> <?= esc($title) ?>: <span class="text-primary"><?= esc($test['test_name']) ?></span>
                </h1>
            ...
            <div class="col-md-8">
                <div class="card card-outline card-info shadow-lg">
                    <div class="card-header">
                        <h3 class="card-title">Update Diagnostic Test Information</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="test_name" id="test_name" 
                                           ...
                                           value="<?= esc(set_value('test_name', $test['test_name'])) ?>" required placeholder="e.g., Complete Blood Count (CBC)">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="test_type" id="test_type" 
                                           ...
                                           value="<?= esc(set_value('test_type', $test['test_type'])) ?>" required placeholder="e.g., Hematology, Biochemistry">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="price" id="price" 
                                           ...
                                           step="0.01" min="0" value="<?= esc(set_value('price', $test['price'])) ?>" required placeholder="0.00">

    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2">
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <?php
                // Get role ID from session for role-based menu display
                $roleId = session()->get('role_id');

                // Determine dashboard URL and active state for staff roles
                ...
                <!-- ------------------------------------------------------------------- -->
                <!-- START: ROLE-BASED MENU SWITCH -->
                <!-- ------------------------------------------------------------------- -->
                <?php if ($roleId == 10): // Patient Portal Menu 
                ?>

                    <li class="nav-item">
                        <a href="<?= base_url('patient-portal/dashboard') ?>" class="nav-link <?= uri_string() == 'patient-portal/dashboard' ? 'active' : '' ?>">
                            <i class="nav-icon fas fa-home"></i>
                            <p>Dashboard</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= base_url('patient-portal/labs') ?>" class="nav-link <?= strpos(uri_string(), 'patient-portal/labs') === 0 ? 'active' : '' ?>">
                            <i class="nav-icon fas fa-flask"></i>
                            <p>Lab Orders</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= base_url('patient-portal/diagnostics') ?>" class="nav-link <?= strpos(uri_string(), 'patient-portal/diagnostics') === 0 ? 'active' : '' ?>">
                            <i class="nav-icon fas fa-x-ray"></i>
                            <p>Diagnostics</p>
                        </a>
                    </li>
                    <!-- Add more patient-specific menu items here as needed -->

                <?php else: // Hospital Staff/Admin Menu (All existing menu items go here) 
                ?>

                    <!-- LINE 1: Dashboard Link for Staff/Admin -->
                    <li class="nav-item">

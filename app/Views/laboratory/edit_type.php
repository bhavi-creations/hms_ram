        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">
                    <i class="fas fa-edit mr-2 text-info"></i> Edit Test Type: <span class="text-primary"><?= esc($type['name']) ?></span>
                </h1>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card card-outline card-info shadow-lg">
                    <div class="card-header">
                        <h3 class="card-title">Update Test Type Details</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('laboratory/types/update/' . $type['id']) ?>" method="post">
                            ...
                            <input type="hidden" name="_method" value="PUT"> <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="type_name" class="form-control <?= session('errors.name') ? 'is-invalid' : '' ?>" 
                                           required value="<?= old('name', $type['name']) ?>" placeholder="e.g., Blood Chemistry">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="description" id="type_description" class="form-control <?= session('errors.description') ? 'is-invalid' : '' ?>" 
                                              rows="3" placeholder="A brief explanation of tests covered by this type."><?= old('description', $type['description']) ?></textarea>
                            ...
                            <div class="form-group text-right">
                                ...
                                <button type="submit" class="btn btn-info"><i class="fas fa-save"></i> Update Type</button>
                            </div>
                        </form>
                    </div>
                    </div>

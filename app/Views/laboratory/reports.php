            ...
            <div class="col-12">
                <div class="card card-primary card-outline rounded-lg shadow-sm">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-file-medical mr-2"></i> Generated Lab Reports</h3>
                    </div>
                                ...
                                <?php if (!empty($labOrders)): ?>
                                    ...
                                    <?php foreach ($labOrders as $order): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('laboratory/report/' . $order['order_id']) ?>" class="btn btn-sm btn-info" title="View Report">
                                                    <i class="fas fa-eye"></i>  
                                                </a>
                                                <a href="#" class="btn btn-sm btn-danger delete-report-btn" data-id="<?= $order['order_id'] ?>" title="Delete Report">
...
<script>
    $(function() {
        ...
        $('.delete-report-btn').on('click', function(e) {
            ...
            const deleteUrl = '<?= base_url('laboratory/reports/delete/') ?>' + orderId; // Assuming the delete route is here
            ...
            Swal.fire({
                ...
                text: "Are you sure you want to delete this lab report? This will delete the results associated with Order ID #" + orderId + ".",
                icon: 'warning',

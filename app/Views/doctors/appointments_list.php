...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h2 class="mb-4">My Appointments - Dr. <?= esc($doctor_name) ?></h2>
            <hr>
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <?php if (!empty($appointments)): ?>
                        <table id="doctorAppointmentsListTable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>S.No</th>
                                    <th>Patient Name</th>
...
<script>
    $(function () {
        $("#doctorAppointmentsListTable").DataTable({ // Changed ID to avoid conflict with dashboard table
            "responsive": true,
            "lengthChange": false,
            "autoWidth": false,
            "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
        }).buttons().container().appendTo('#doctorAppointmentsListTable_wrapper .col-md-6:eq(0)');
    });
</script>
<?= $this->endSection() ?>
